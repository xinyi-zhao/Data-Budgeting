...
def parse_cmd():
    ...
    parser.add_argument("--use_num", type=list, default=[85],help='5 * x for selecting the number for use', nargs='+')
    ...
    parser.add_argument("--meta_value", type=list, default=[],help = 'feature_cnt/max_coev/label_ratio', nargs='+')
    ...
    parser.add_argument("--use_file", type=list, default=['dataset_data_100.csv', 'dataset_data_noised.csv'], nargs='+')
